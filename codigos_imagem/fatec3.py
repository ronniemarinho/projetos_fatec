...
def predict_age(input_path: str):
    ...
    for i, (start_x, start_y, end_x, end_y) in enumerate(faces):
        ...
        label = f"Idade entre {primeiro_numero} a {segundo_numero} anos"
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if key == ord('c'):
            ...
            cv2.imwrite('foto_alta.jpg', frame)
            print("Foto tirada e salva como 'foto_alta.jpg'")
            break
